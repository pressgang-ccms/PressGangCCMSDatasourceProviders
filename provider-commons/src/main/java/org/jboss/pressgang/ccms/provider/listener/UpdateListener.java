...
public interface UpdateListener extends ProviderListener {
    <T extends AuditedEntityWrapper<T>> void handleUpdateEntity(T entity);
    <T extends AuditedEntityWrapper<T>> void handleUpdateEntityCollection(CollectionWrapper<T> collection);
}
