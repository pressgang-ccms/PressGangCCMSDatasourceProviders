...
import org.jboss.pressgang.ccms.contentspec.wrapper.DBTopicWrapper;
...
public class DBTopicProvider extends DBDataProvider implements TopicProvider {
    ...
    public CollectionWrapper<TopicSourceURLWrapper> getTopicSourceUrls(int id, Integer revision) {
        ...
        if (topic == null) {
            ...
            return getWrapperFactory().createCollection(topic.unwrap().getTopicSourceUrls(), TopicSourceUrl.class,
                    revision != null);
        }
    }
    ...
    public CollectionWrapper<TranslatedTopicWrapper> getTopicTranslations(int id, final Integer revision) {
        ...
        topic.setTopicId(id);
        return getWrapperFactory().createCollection(topic.getTranslatedTopics(getEntityManager(), revision),
