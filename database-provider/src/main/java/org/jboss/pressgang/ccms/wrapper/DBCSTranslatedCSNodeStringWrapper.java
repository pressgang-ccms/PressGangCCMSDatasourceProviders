...
public class DBCSTranslatedCSNodeStringWrapper extends DBBaseWrapper<TranslatedCSNodeStringWrapper> implements TranslatedCSNodeStringWrapper {
    private final TranslatedCSNodeString translatedCSNodeString;

    public DBCSTranslatedCSNodeStringWrapper(final DBProviderFactory providerFactory, final TranslatedCSNodeString translatedCSNodeString,
            boolean isRevision) {
