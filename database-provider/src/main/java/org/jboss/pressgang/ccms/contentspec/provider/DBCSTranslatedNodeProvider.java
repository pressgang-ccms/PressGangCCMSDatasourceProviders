...
import org.jboss.pressgang.ccms.contentspec.wrapper.DBCSTranslatedNodeWrapper;
...
public class DBCSTranslatedNodeProvider extends DBDataProvider implements CSTranslatedNodeProvider {
    ...
    public UpdateableCollectionWrapper<CSTranslatedNodeStringWrapper> getCSTranslatedNodeStrings(int id, Integer revision) {
        ...
        if (translatedNode == null) {
            ...
            final CollectionWrapper<CSTranslatedNodeStringWrapper> collection = getWrapperFactory().createCollection(translatedNode
                    .unwrap().getCSTranslatedNodeStrings(),
                    CSTranslatedNodeString.class, revision != null);
    ...
    @Override
    public CollectionWrapper<CSTranslatedNodeWrapper> createCSTranslatedNodes(CollectionWrapper<CSTranslatedNodeWrapper> nodes) throws Exception {
    ...
    public UpdateableCollectionWrapper<CSTranslatedNodeWrapper> newCSTranslatedNodeCollection() {
        final CollectionWrapper<CSTranslatedNodeWrapper> collection = getWrapperFactory().createCollection(new ArrayList<CSTranslatedNode>(), CSTranslatedNode.class,
                false, CSTranslatedNodeWrapper.class);
