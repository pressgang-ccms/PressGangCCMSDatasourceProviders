...
public class RESTTranslationServerCollectionV1Wrapper extends RESTCollectionWrapper<TranslationServerWrapper,
        RESTTranslationServerV1, RESTTranslationServerCollectionV1> implements CollectionWrapper<TranslationServerWrapper> {

    public RESTTranslationServerCollectionV1Wrapper(final RESTProviderFactory providerFactory,
            final RESTTranslationServerCollectionV1 collection, boolean isRevisionCollection) {
