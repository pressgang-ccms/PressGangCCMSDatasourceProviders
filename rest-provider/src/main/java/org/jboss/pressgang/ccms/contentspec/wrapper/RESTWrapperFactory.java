...
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTBlobConstantCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTCSNodeCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTCSRelatedNodeCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTCSTranslatedNodeCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTCSTranslatedNodeStringCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTCategoryCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTCategoryInTagCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTContentSpecCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTImageCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTLanguageImageCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTPropertyTagCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTPropertyTagInContentSpecCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTPropertyTagInPropertyCategoryCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTPropertyTagInTagCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTPropertyTagInTopicCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTStringConstantCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTTagCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTTagInCategoryCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTTopicCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTTopicSourceURLCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTTranslatedTopicCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTTranslatedTopicStringCollectionV1Wrapper;
import org.jboss.pressgang.ccms.contentspec.wrapper.collection.RESTUserCollectionV1Wrapper;
...
public class RESTWrapperFactory extends WrapperFactory {
    ...
    public <T extends EntityWrapper<T>> T create(final Object entity, boolean isRevision) {
        ...
        if (entity instanceof RESTTopicV1) {
            ...
            throw new UnsupportedOperationException(
                    "A parent is needed to get CSTranslatedNodeStrings using V1 of the REST Interface.");
        } else {
