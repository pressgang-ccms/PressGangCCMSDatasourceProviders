...
public class RESTCollectionProxyFactory {
    ...
    public static <T extends RESTBaseEntityV1<T, U, V>, U extends RESTBaseCollectionV1<T, U, V>, V extends RESTBaseCollectionItemV1<T,
            U, V>> U create(final RESTProviderFactory providerFactory, final U collection,
            boolean isRevision) {
    ...
    public static <T extends RESTBaseEntityV1<T, U, V>, U extends RESTBaseCollectionV1<T, U, V>, V extends RESTBaseCollectionItemV1<T,
            U, V>> U create(final RESTProviderFactory providerFactory, final U collection,
            boolean isRevision, RESTBaseEntityV1<?, ?, ?> parent) {
    ...
    private static <T extends RESTBaseEntityV1<T, U, V>, U extends RESTBaseCollectionV1<T, U, V>, V extends RESTBaseCollectionItemV1<T,
