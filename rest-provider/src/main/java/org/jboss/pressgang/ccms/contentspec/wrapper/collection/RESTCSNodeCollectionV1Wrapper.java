...
public class RESTCSNodeCollectionV1Wrapper extends RESTCollectionWrapper<CSNodeWrapper, RESTCSNodeV1,
        RESTCSNodeCollectionV1> implements CollectionWrapper<CSNodeWrapper> {
