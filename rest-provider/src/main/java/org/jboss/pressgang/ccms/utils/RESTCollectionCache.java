...
public class RESTCollectionCache {
    ...
    public <T extends RESTBaseEntityV1<T>, U extends RESTBaseEntityCollectionV1<T, U, ?>> void add(final Class<T> clazz, final U value) {
    ...
    public <T extends RESTBaseEntityV1<T>, U extends RESTBaseEntityCollectionV1<T, U, ?>> U get(final Class<T> clazz,
