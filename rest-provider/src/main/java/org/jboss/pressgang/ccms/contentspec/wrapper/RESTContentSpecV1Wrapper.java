...
public class RESTContentSpecV1Wrapper extends RESTBaseWrapper<ContentSpecWrapper, RESTContentSpecV1> implements ContentSpecWrapper {
    ...
    public String getTitle() {
        final CSNodeWrapper node = getWrapperFactory().create(
                ComponentContentSpecV1.returnMetaData(getProxyEntity(), CSConstants.TITLE_TITLE), isRevisionEntity(), CSNodeWrapper.class);
    ...
    public String getProduct() {
        final CSNodeWrapper node = getWrapperFactory().create(
                ComponentContentSpecV1.returnMetaData(getProxyEntity(), CSConstants.PRODUCT_TITLE), isRevisionEntity(),
                CSNodeWrapper.class);
        return node == null ? null : node.getAdditionalText();
    }
    ...
    public String getVersion() {
        final CSNodeWrapper node = getWrapperFactory().create(
                ComponentContentSpecV1.returnMetaData(getProxyEntity(), CSConstants.VERSION_TITLE), isRevisionEntity(),
                CSNodeWrapper.class);
        return node == null ? null : node.getAdditionalText();
    }
